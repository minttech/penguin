...
var obstaclesGroup,obstaclesGroup2,obstacle1,obstacle2,obstacle3,obstacle4;
...
function preload(){
ground_image=loadImage("bg4.jpg");
 
 girl_running=loadAnimation("1.png","2.png","3.png");
 ...
 zombie_running=loadAnimation("devil2.png");
 ...
 // obstacle1=loadImage("obstacle1.png");
  ...
  zombie_idle=loadImage("devil1.png");
  jumpSound = loadSound("jump.mp3")
  dieSound = loadSound("smb_gameover.mp3")
  checkPointSound = loadSound("smb_coin.mp3")
  gameOverImage=loadImage("gameOver1.png");
  restartImage=loadImage("restart1.png");
  //girl_collided=loadImage("Dead (30).png");
  girl_collided=loadImage("col.png");
  girlImage=loadImage("Idle (1).png");

  birdsimg = loadAnimation("e1.png", "e2.png", "e3.png");
}

function setup() {
 createCanvas(windowWidth,windowHeight);
  
ground=createSprite(width/2,0);
...
girl=createSprite(300,420,600,10);
 ...
 // zombie.velocityX=Math.round(random(1,2));
  ...
  restart = createSprite(width/2,180);
...
function spawnBirds(){
  if(frameCount % 60 === 0){
    var bird = createSprite(200,900,40,40);
    bird.velocityX=-9;

       bird.y = Math.round(random(1,6));
  //  bird.addImage(birdsimg);
  //  bird.scale=0.18;
   // bird.debug=false;
 //   bird.setCollider("circle",0,0,1);
